...
pub const ExceptionCause = enum(u31) {
    ...
    HardwareError,
    // Custom
    HaltAddressWritten = 63, // If an address designated a halt address is stored to, raise this exception
...
const instructions = .{
    ...
    .mul = .{ .func = assembleRType, .opcode = Opcode.OP, .funct3 = Funct3.OP.mul, .funct7 = Funct7.OP.muldiv },
    .mulh = .{ .func = assembleRType, .opcode = Opcode.OP, .funct3 = Funct3.OP.mulh, .funct7 = Funct7.OP.muldiv },
    .mulhu = .{ .func = assembleRType, .opcode = Opcode.OP, .funct3 = Funct3.OP.mulhu, .funct7 = Funct7.OP.muldiv },
    .mulhsu = .{ .func = assembleRType, .opcode = Opcode.OP, .funct3 = Funct3.OP.mulhsu, .funct7 = Funct7.OP.muldiv },
    .div = .{ .func = assembleRType, .opcode = Opcode.OP, .funct3 = Funct3.OP.div, .funct7 = Funct7.OP.muldiv },
    .divu = .{ .func = assembleRType, .opcode = Opcode.OP, .funct3 = Funct3.OP.divu, .funct7 = Funct7.OP.muldiv },
    .rem = .{ .func = assembleRType, .opcode = Opcode.OP, .funct3 = Funct3.OP.rem, .funct7 = Funct7.OP.muldiv },
    .remu = .{ .func = assembleRType, .opcode = Opcode.OP, .funct3 = Funct3.OP.remu, .funct7 = Funct7.OP.muldiv },
